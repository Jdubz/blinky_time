...
float SimplexNoise::fade(float t) { return t*t*t*(t*(t*6-15)+10); }
float SimplexNoise::lerp(float a, float b, float t) { return a + t*(b-a); }
...
float SimplexNoise::noise(float x) { return noise(x,0.0f,0.0f); }
float SimplexNoise::noise(float x, float y) { return noise(x,y,0.0f); }
