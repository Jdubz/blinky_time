...
public:
    ...
    static_assert(sizeof(StoredTrackerParams) == 108,
        "StoredTrackerParams size changed! Increment SETTINGS_VERSION and update assertion. (108 bytes = 26 floats + 1 uint16 + padding)");
