...
FireParticle::FireParticle() : heat_(nullptr), params_(), beatCount_(0) {}
...
bool FireParticle::begin(const DeviceConfig& config) {
...
void FireParticle::generate(PixelMatrix& matrix, const AudioControl& audio) {
...
void FireParticle::spawnParticles(float dt) {
...
void FireParticle::updateParticle(Particle* p, float dt) {
...
void FireParticle::renderParticle(const Particle* p, PixelMatrix& matrix) {
...
void FireParticle::applyCooling() {
...
void FireParticle::blendHeatToMatrix(PixelMatrix& matrix) {
