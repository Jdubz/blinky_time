...
def emit_cpp(
    ...
    lines = [
        ...
        "// emitted below this comment is the compile-time tripwire — it fires if",
        "// the table is pasted into a build whose constants disagree, which is",
        "// exactly the v33 size-mismatch zero-fill regression.",
        "// Generated table — DO NOT EDIT by hand. Re-run the generator.",
        "static_assert(SpectralConstants::NUM_MEL_BANDS == "
        f"{n_mels},",
        f'    "MEL_BANDS table was generated for {n_mels} bands; '
        'NUM_MEL_BANDS in SharedSpectralAnalysis.h disagrees. Regenerate the '
        'table or update the constant.");',
        f"static_assert(SpectralConstants::MEL_MIN_FREQ == {fmin}f,",
        f'    "MEL_BANDS table was generated for fmin={fmin}; constant disagrees.");',
        f"static_assert(SpectralConstants::MEL_MAX_FREQ == {fmax}f,",
        f'    "MEL_BANDS table was generated for fmax={fmax}; constant disagrees.");',
        f"static_assert(SpectralConstants::FFT_SIZE == {n_fft},",
        f'    "MEL_BANDS table was generated for n_fft={n_fft}; FFT_SIZE disagrees.");',
        f"static_assert(SpectralConstants::SAMPLE_RATE == {sr}.0f,",
        f'    "MEL_BANDS table was generated for sr={sr}; SAMPLE_RATE disagrees.");',
