 ...
 */
export const COOLDOWN_STRESS_20MS = {
 ...
 */
export const COOLDOWN_STRESS_40MS = {
 ...
 */
export const COOLDOWN_STRESS_80MS = {
 ...
 */
export const THRESHOLD_GRADIENT = {
 ...
 */
export const NON_MUSICAL_RANDOM = {
 ...
 */
export const NON_MUSICAL_CLUSTERED = {
 ...
 */
function transientMeta(pattern, targetParams, priority = 5) {
    return {
        id: pattern.id,
        name: pattern.name,
        category: 'transient',
 ...
 */
function rejectionMeta(pattern, targetParams, priority = 5) {
    return {
        id: pattern.id,
        name: pattern.name,
        category: 'rejection',
 ...
 */
function paramTargetedMeta(pattern, targetParams, priority = 7) {
    return {
        id: pattern.id,
        name: pattern.name,
 ...
 */
function musicModeMeta(pattern, targetParams, priority = 6) {
    return {
        id: pattern.id,
        name: pattern.name,
        category: 'music-mode',
 ...
 */
function extendPattern(pattern, metadata) {
 ...
 */
export function getExtendedPatternById(id) {
    return PATTERN_REGISTRY[id];
}
/**
 * Get all patterns that target a specific parameter
 */
export function getPatternsForParam(param) {
