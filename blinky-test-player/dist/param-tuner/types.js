 ...
 */
// All detector types
export const DETECTOR_TYPES = ['drummer', 'spectral', 'hfc', 'bass', 'complex', 'mel'];
export const SUBSYSTEM_MODES = ['music', 'rhythm'];
export const ALL_MODES = ['ensemble', ...SUBSYSTEM_MODES];
/**
 ...
 */
export function generateSweepValues(param) {
    ...
    for (let i = 0;; i++) {
        ...
        if (v > param.max + 1e-9)
            break; // Small epsilon for floating-point comparison
