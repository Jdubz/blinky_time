 ...
 */
export type PatternCategory = 'transient' | 'music-mode' | 'parameter-targeted' | 'rejection';
/**
 * Metric types that can be optimized for
 */
export type OptimizationMetric = 'f1' | 'precision' | 'recall' | 'bpm_accuracy' | 'phase_stability' | 'lock_time' | 'rejection_rate';
/**
